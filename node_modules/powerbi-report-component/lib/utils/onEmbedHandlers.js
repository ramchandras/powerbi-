...
var reportHandler = function (report, reportRef, props) {
    ...
    report.on('loaded', function () {
        utils_1.validateAndInvokeCallback(props.onLoad, reportInstance);
    });
    report.on('error', function (event) {
        return utils_1.validateAndInvokeCallback(props.onError, event.detail);
    });
    report.on('saved', function (event) {
        return utils_1.validateAndInvokeCallback(props.onSave, event.detail);
    });
    if (!isCreateMode) {
        report.on('rendered', function () {
            return utils_1.validateAndInvokeCallback(props.onRender, reportInstance);
        });
        report.on('dataSelected', function (event) {
            return utils_1.validateAndInvokeCallback(props.onSelectData, event.detail);
        });
        report.on('pageChanged', function (event) {
            return utils_1.validateAndInvokeCallback(props.onPageChange, event.detail);
        });
        report.on('buttonClicked', function (event) {
            return utils_1.validateAndInvokeCallback(props.onButtonClicked, event.detail);
        });
        report.on('commandTriggered', function (event) {
            return utils_1.validateAndInvokeCallback(props.onCommandTriggered, event.detail);
        });
    }
};
...
var dashboardHandler = function (dashboard, dashboardRef, props) {
    ...
    dashboard.on('tileClicked', function (event) {
        return utils_1.validateAndInvokeCallback(props.onTileClicked, event.detail);
    });
};
exports.dashboardHandler = dashboardHandler;
var tileHandler = function (tile, props) {
    tile.on('tileLoaded', function (event) {
        return utils_1.validateAndInvokeCallback(props.onLoad, event.detail);
    });
    tile.on('tileClicked', function (event) {
        return utils_1.validateAndInvokeCallback(props.onClick, event.detail);
    });
};
