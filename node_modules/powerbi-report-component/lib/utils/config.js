...
var createReportConfig = function (props) {
    ...
    var cleanSettings = index_1.clean(__assign({ filterPaneEnabled: true, navContentPaneEnabled: true }, extraSettings));
    var cleanDataSetBinding = index_1.clean({
        datasetId: datasetId,
    });
    var settings = index_1.isEmptyObject(cleanSettings)
        ? {}
        : {
            settings: cleanSettings,
        };
    var datasetBinding = index_1.isEmptyObject(cleanDataSetBinding)
        ? {}
        : {
            datasetBinding: cleanDataSetBinding,
        };
    return index_1.clean(__assign(__assign({ type: 'report', tokenType: powerbi_client_1.models.TokenType[tokenType], accessToken: accessToken,
        embedUrl: embedUrl, id: embedId, pageName: pageName, viewMode: powerbi_client_1.models.ViewMode[reportMode], permissions: powerbi_client_1.models.Permissions[permissions], reportMode: reportMode }, settings), datasetBinding));
};
